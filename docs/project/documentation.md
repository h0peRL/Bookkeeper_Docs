...
| 5.1             | 7             | Have your SME chart and the script ready.                                  | Chrome, VSC                                              | Compare SME chart Balancesheet accounts with the insert command of the SQL script             | All balance sheet accounts listed in the SME chart of accounts appear in the insert command.    |
